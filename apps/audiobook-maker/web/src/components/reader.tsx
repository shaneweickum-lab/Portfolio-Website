...
export function Reader({
  ...
  if (reader.status === "unsupported") {
    return (
      <div className="mx-auto flex max-w-xl flex-1 flex-col items-center justify-center px-6 py-16 text-center">
        <p className="rounded-lg border border-accent-strong/40 bg-accent-strong/10 px-4 py-3 text-sm text-accent-strong">
          This browser doesn&apos;t support text-to-speech (the Web Speech
          API). Try Chrome, Edge, or Safari.
        </p>
        <button onClick={onClose} className="mt-6 text-sm text-accent">
          Back
        </button>
      </div>
    );
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-1 flex-col px-6 py-10">
      ...
      <div className="mt-8 flex flex-1 items-center justify-center rounded-2xl border border-border bg-surface p-8">
      ...
      {reader.errorMessage && (
        <p className="mt-6 rounded-lg border border-accent-strong/40 bg-accent-strong/10 px-4 py-2 text-center text-sm text-accent-strong">
          {reader.errorMessage}
        </p>
      )}
      ...
      <div className="mt-8 flex items-center justify-center gap-4">
        ...
        <button
          ...
          className="flex h-16 w-16 items-center justify-center rounded-full bg-accent text-background"
        >

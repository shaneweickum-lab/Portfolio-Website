...
export function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "customers" | "newsletter">("overview");
          ...
          <div className="mx-auto max-w-6xl px-6 flex gap-6">
            {[
              ...
              <button
                key={tab.id}
                onClick={() =>
                  setActiveTab(tab.id as "overview" | "customers" | "newsletter")
                }
              ...
              <NewsletterComposer
                onSuccess={() => {
                  if (stats) {
                    setStats({
                      ...stats,
                      communicationCount: stats.communicationCount + 1,
                    });
                  }
                }}
              />
